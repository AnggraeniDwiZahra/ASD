...
{
    do {
        cout<<"Single Linkede List Sircular (SLLC)" << endl;
        cout<<"==================================="<<endl;
        ...
        default:
            cout<<"\nTERIMA KASIH"<<endl;
            cout<<"Program was made by Anggraeni Dwi Zahra (2410817220018)."<<endl;
        }
    ...
    void cariData() {
        if(isEmpty() == 0) {
            ...
            if(apaDitemukan == false)
                cout<<"Data \""<<cari<<"\" tidak ditemukan pada inked List."<<endl;
        } else cout<<"Tidak terdapat data pada Linked List."<<endl;
    }
    ...
    } else cout<<"Tidak terdapat data pad Linked List."<<endl;
    }
    ...
    void sisipkanSetelah() {
        if(isEmpty() == 0) {
            ...
            if(apaAda == true) {
                ...
                cout << "Data \""<<dataBaru<<"\" berhasil disisipkan setelah dara \""<<prevData<<"\"."<<endl;
            } else {
